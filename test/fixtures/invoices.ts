...
export const PROFILES: Profile[] = [
  ...
  { id: 'p-milan', display_name: 'Milan', initials: 'MI', accent: 'person-3', role: 'manager', notify_on_new_invoice: false,
  reminder_time: null,
  title: 'COO', active: true, business_id: null },
  { id: 'p-sujan', display_name: 'Sujan', initials: 'SU', accent: 'person-4', role: 'manager', notify_on_new_invoice: false,
  reminder_time: null,
